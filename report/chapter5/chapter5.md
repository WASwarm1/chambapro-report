...
|  **TS25**  |      Validaciones de dominio en entidades       | T21  | Implementar validaciones en Users                                | Validar email único, formato de email, contraseña segura, datos de técnico                           |          3           |              | To do  |
...
|            |                                                 | T24  | Implementar validaciones en Reviews                              | Validar rating (1-5), comentario requerido, relación técnico-cliente                                 |          2           |              | To do  |
|  **TS18**  |           Encriptación de contraseñas           | T25  | Implementar IHashingService                                      | Crear interfaz para servicios de hashing de contraseñas                                              |          1           | Werner Lang  |  Done  |
|            |                                                 | T26  | Implementar HashingService con BCrypt                            | Crear implementación usando BCrypt.Net para hash y verificación                                      |          2           | Werner Lang  |  Done  |
|            |                                                 | T27  | Configurar salt rounds                                           | Definir configuración óptima de seguridad para BCrypt (work factor)                                  |          1           | Werner Lang  |  Done  |
|            |                                                 | T28  | Pruebas unitarias de hashing                                     | Verificar correcto funcionamiento de hash y verificación de contraseñas                              |          2           | Werner Lang  |  Done  |
|  **TS15**  |          Registro de usuario (Sign Up)          | T29  | Crear SignUpCommand                                              | Definir record con todos los campos necesarios para registro (Email, Password, Name, etc.)           |          1           | Werner Lang  |  Done  |
|            |                                                 | T30  | Implementar validaciones de registro                             | Validar formato de email, fuerza de contraseña, y datos de técnico si aplica                         |          3           | Werner Lang  |  Done  |
|            |                                                 | T31  | Crear entidad Users                                              | Implementar agregado Users con constructores para Client y Technician                                |          4           | Werner Lang  |  Done  |
|            |                                                 | T32  | Implementar UserCommandService.Handle(SignUpCommand)             | Crear lógica de negocio para registro incluyendo hash de contraseña                                  |          4           | Werner Lang  |  Done  |
|            |                                                 | T33  | Crear SignUpResource y endpoint                                  | Implementar endpoint POST /api/v1/authentication/sign-up                                             |          2           | Werner Lang  |  Done  |
|            |                                                 | T34  | Pruebas de registro                                              | Verificar registro exitoso de clientes y técnicos, y validación de errores                           |          3           | Werner Lang  |  Done  |
|  **TS16**  |           Inicio de sesión (Sign In)            | T35  | Crear SignInCommand                                              | Definir record con Email, Password y UserType                                                        |          1           | Werner Lang  |  Done  |
|            |                                                 | T36  | Implementar ITokenService                                        | Crear interfaz para generación y validación de tokens JWT                                            |          1           | Werner Lang  |  Done  |
|            |                                                 | T37  | Implementar TokenService                                         | Crear servicio JWT con generación de tokens y claims (UserId, Email, UserType)                       |          4           | Werner Lang  |  Done  |
|            |                                                 | T38  | Configurar TokenSettings                                         | Definir configuración de JWT Secret en appsettings.json                                              |          1           | Werner Lang  |  Done  |
|            |                                                 | T39  | Implementar UserCommandService.Handle(SignInCommand)             | Validar credenciales, verificar contraseña y generar token                                           |          3           | Werner Lang  |  Done  |
|            |                                                 | T40  | Crear endpoint sign-in                                           | Implementar endpoint POST /api/v1/authentication/sign-in                                             |          2           | Werner Lang  |  Done  |
|            |                                                 | T41  | Pruebas de autenticación                                         | Verificar login exitoso, token válido y manejo de errores                                            |          3           | Werner Lang  |  Done  |
|  **TS17**  |           Middleware de autorización            | T42  | Crear RequestAuthorizationMiddleware                             | Implementar middleware para extraer y validar token JWT de headers                                   |          4           | Werner Lang  |  Done  |
|            |                                                 | T43  | Crear AuthorizeAttribute                                         | Implementar filtro de autorización personalizado                                                     |          2           | Werner Lang  |  Done  |
|            |                                                 | T44  | Crear AllowAnonymousAttribute                                    | Implementar atributo para endpoints públicos                                                         |          1           | Werner Lang  |  Done  |
|            |                                                 | T45  | Configurar pipeline de middleware                                | Registrar middleware en Program.cs antes de UseAuthorization                                         |          2           | Werner Lang  |  Done  |
|            |                                                 | T46  | Pruebas de autorización                                          | Verificar protección de endpoints y acceso correcto con token válido                                 |          3           | Werner Lang  |  Done  |
|  **TS21**  |            Command y Query Services             | T47  | Definir IUserCommandService                                      | Crear interfaz con métodos Handle para UpdateProfile y UpdateTechnicianProfile                       |          2           | Werner Lang  |  Done  |
|            |                                                 | T48  | Definir IUserQueryService                                        | Crear interfaz con métodos Handle para queries de usuarios                                           |          2           | Werner Lang  |  Done  |
|            |                                                 | T49  | Implementar Command Services                                     | Crear UserCommandService con lógica de actualización de perfiles                                     |          4           |              | To do  |
|            |                                                 | T50  | Implementar Query Services                                       | Crear UserQueryService con lógica de consultas                                                       |          3           |              | To do  |
|            |                                                 | T51  | Registrar servicios                                              | Configurar inyección de dependencias en Program.cs                                                   |          1           | Werner Lang  |  Done  |
|  **TS10**  |      Obtener perfil de usuario autenticado      | T52  | Crear GetUserByIdQuery                                           | Definir query record con UserId                                                                      |          1           | Werner Lang  |  Done  |
|            |                                                 | T53  | Implementar endpoint GET /me                                     | Crear endpoint que obtiene usuario del contexto HTTP                                                 |          2           | Werner Lang  |  Done  |
|            |                                                 | T54  | Crear UserResource                                               | Definir DTO con todos los campos del usuario                                                         |          2           | Werner Lang  |  Done  |
|            |                                                 | T55  | Implementar UserResourceFromEntityAssembler                      | Crear transformador de entidad a resource                                                            |          2           | Werner Lang  |  Done  |
|            |                                                 | T56  | Pruebas de obtención de perfil                                   | Verificar obtención correcta de perfil autenticado                                                   |          2           | Werner Lang  |  Done  |
|  **TS11**  |          Actualizar perfil de usuario           | T57  | Crear UpdateProfileCommand                                       | Definir command con campos Name, Lastname, Phone, Avatar                                             |          1           |              | To do  |
|            |                                                 | T58  | Implementar lógica de actualización                              | Crear método UpdateProfile en entidad Users                                                          |          2           |              | To do  |
|            |                                                 | T59  | Implementar endpoint PUT /{id}/profile                           | Crear endpoint con validación de autorización                                                        |          3           |              | To do  |
|            |                                                 | T60  | Validar propiedad del perfil                                     | Verificar que usuario autenticado coincida con id del perfil                                         |          2           |              | To do  |
|            |                                                 | T61  | Pruebas de actualización                                         | Verificar actualización exitosa y manejo de errores de autorización                                  |          2           |              | To do  |
|  **TS12**  |          Actualizar perfil de técnico           | T62  | Crear UpdateTechnicianProfileCommand                             | Definir command con campos técnicos (Speciality, Description, etc.)                                  |          1           |              | To do  |
|            |                                                 | T63  | Implementar validaciones específicas                             | Validar HourlyRate (10-500), descripción mínima, especialidades válidas                              |          3           |              | To do  |
|            |                                                 | T64  | Implementar UpdateTechnicianProfile en entidad                   | Crear método con validación de UserType                                                              |          2           |              | To do  |
|            |                                                 | T65  | Implementar endpoint PUT /{id}/technician-profile                | Crear endpoint con autorización y validaciones                                                       |          3           |              | To do  |
|            |                                                 | T66  | Pruebas de actualización técnico                                 | Verificar actualización exitosa y validaciones de dominio                                            |          3           |              | To do  |
|  **TS13**  |           Obtener todos los técnicos            | T67  | Crear GetAllTechniciansQuery                                     | Definir query record vacío                                                                           |          1           |              | To do  |
|            |                                                 | T68  | Implementar repositorio FindAllTechniciansAsync                  | Crear query filtrada por UserType.Technician                                                         |          2           |              | To do  |
|            |                                                 | T69  | Implementar endpoint GET /technicians                            | Crear endpoint que retorna lista de técnicos                                                         |          2           |              | To do  |
|            |                                                 | T70  | Pruebas de listado                                               | Verificar obtención correcta de todos los técnicos                                                   |          2           |              | To do  |
|  **TS14**  |        Obtener técnicos por especialidad        | T71  | Crear GetTechniciansBySpecialityQuery                            | Definir query record con campo Speciality                                                            |          1           |              | To do  |
|            |                                                 | T72  | Implementar repositorio FindTechniciansBySpecialityAsync         | Crear query filtrada por especialidad                                                                |          2           |              | To do  |
|            |                                                 | T73  | Implementar endpoint GET /technicians/by-speciality/{speciality} | Crear endpoint con parámetro de ruta                                                                 |          2           |              | To do  |
|            |                                                 | T74  | Validar especialidades permitidas                                | Implementar validación de especialidades válidas                                                     |          2           |              | To do  |
|            |                                                 | T75  | Pruebas de filtrado                                              | Verificar filtrado correcto por especialidad                                                         |          2           |              | To do  |
|  **TS22**  |           Recursos REST y Assemblers            | T76  | Crear Resources para Reservations                                | Definir CreateReserveResource, UpdateReserveResource, ReserveResource                                |          3           | Werner Lang  |  Done  |
|            |                                                 | T77  | Implementar Assemblers para Reservations                         | Crear transformadores bidireccionales entre Resources y Commands/Entities                            |          4           | Werner Lang  |  Done  |
|            |                                                 | T78  | Crear Resources para Services                                    | Definir CreateServiceResource, UpdateServiceResource, ServiceResource                                |          2           | Werner Lang  |  Done  |
|            |                                                 | T79  | Implementar Assemblers para Services                             | Crear transformadores para Services                                                                  |          3           | Werner Lang  |  Done  |
|            |                                                 | T80  | Crear Resources para Reviews                                     | Definir CreateReviewResource, ReviewResource                                                         |          2           | Werner Lang  |  Done  |
|            |                                                 | T81  | Implementar Assemblers para Reviews                              | Crear transformadores para Reviews                                                                   |          2           | Werner Lang  |  Done  |
|  **TS02**  |               Crear nueva reserva               | T82  | Crear CreateReserveCommand                                       | Definir command con Date, Time, Description, ClientId, CategoryId                                    |          1           | Werner Lang  |  Done  |
|            |                                                 | T83  | Crear entidad Reserve                                            | Implementar agregado Reserve con constructor y validaciones                                          |          3           | Werner Lang  |  Done  |
|            |                                                 | T84  | Implementar IReserveRepository                                   | Crear interfaz de repositorio con métodos específicos                                                |          2           | Werner Lang  |  Done  |
|            |                                                 | T85  | Implementar ReserveRepository                                    | Crear implementación con Entity Framework                                                            |          3           | Werner Lang  |  Done  |
|            |                                                 | T86  | Implementar ReserveCommandService.Handle(CreateReserveCommand)   | Crear lógica de negocio con validaciones (fecha futura, límite 30 días, etc.)                        |          4           | Werner Lang  |  Done  |
|            |                                                 | T87  | Implementar endpoint POST /reservations                          | Crear endpoint con autenticación                                                                     |          2           | Werner Lang  |  Done  |
|            |                                                 | T88  | Pruebas de creación                                              | Verificar creación exitosa y validaciones de negocio                                                 |          3           | Werner Lang  |  Done  |
|  **TS01**  |     Obtener reservas por cliente o técnico      | T89  | Crear queries para filtros                                       | Definir GetReservesByClientIdQuery y GetReservesByTechnicianIdQuery                                  |          2           | Werner Lang  |  Done  |
|            |                                                 | T90  | Implementar métodos de repositorio                               | Crear FindByClientIdAsync y FindByTechnicianIdAsync                                                  |          3           | Werner Lang  |  Done  |
|            |                                                 | T91  | Implementar IReserveQueryService                                 | Crear interfaz con métodos Handle para queries                                                       |          2           | Werner Lang  |  Done  |
|            |                                                 | T92  | Implementar ReserveQueryService                                  | Crear implementación de queries                                                                      |          3           | Werner Lang  |  Done  |
|            |                                                 | T93  | Implementar endpoint GET /reservations                           | Crear endpoint con parámetros query clientId y technicianId                                          |          3           | Werner Lang  |  Done  |
|            |                                                 | T94  | Pruebas de filtrado                                              | Verificar filtrado correcto por cliente y técnico                                                    |          2           | Werner Lang  |  Done  |
|  **TS03**  |          Actualizar reserva existente           | T95  | Crear UpdateReserveCommand                                       | Definir command con todos los campos incluyendo Status                                               |          1           | Werner Lang  |  Done  |
|            |                                                 | T96  | Implementar método UpdateFromCommand en Reserve                  | Crear método para actualizar todos los campos                                                        |          2           | Werner Lang  |  Done  |
|            |                                                 | T97  | Implementar ReserveCommandService.Handle(UpdateReserveCommand)   | Implementar lógica con validaciones de estado                                                        |          4           | Werner Lang  |  Done  |
|            |                                                 | T98  | Implementar endpoint PUT /reservations/{id}                      | Crear endpoint con validación de ID                                                                  |          2           | Werner Lang  |  Done  |
|            |                                                 | T99  | Pruebas de actualización                                         | Verificar actualización y validaciones de transición de estado                                       |          3           | Werner Lang  |  Done  |
|  **TS04**  |                Cancelar reserva                 | T100 | Crear CancelReserveCommand                                       | Definir command con ReserveId                                                                        |          1           | Werner Lang  |  Done  |
|            |                                                 | T101 | Implementar método Cancel en Reserve                             | Crear método con validación de cancelabilidad                                                        |          2           | Werner Lang  |  Done  |
|            |                                                 | T102 | Implementar ReserveCommandService.Handle(CancelReserveCommand)   | Implementar lógica con validación de tiempo (2 horas antes)                                          |          3           | Werner Lang  |  Done  |
|            |                                                 | T103 | Implementar endpoint PATCH /reservations/{id}/cancel             | Crear endpoint específico para cancelación                                                           |          2           | Werner Lang  |  Done  |
|            |                                                 | T104 | Pruebas de cancelación                                           | Verificar cancelación exitosa y restricciones temporales                                             |          2           | Werner Lang  |  Done  |
|  **TS06**  |              Crear nuevo servicio               | T105 | Crear CreateServiceCommand                                       | Definir command con todos los campos de servicio                                                     |          1           | Werner Lang  |  Done  |
|            |                                                 | T106 | Crear entidad Services                                           | Implementar agregado Services con validaciones                                                       |          3           | Werner Lang  |  Done  |
|            |                                                 | T107 | Implementar IServiceRepository                                   | Crear interfaz de repositorio                                                                        |          2           | Werner Lang  |  Done  |
|            |                                                 | T108 | Implementar ServiceRepository                                    | Crear implementación con Entity Framework                                                            |          3           | Werner Lang  |  Done  |
|            |                                                 | T109 | Implementar IServiceCommandService                               | Crear interfaz con métodos Handle                                                                    |          2           | Werner Lang  |  Done  |
|            |                                                 | T110 | Implementar ServiceCommandService.Handle(CreateServiceCommand)   | Crear lógica de creación                                                                             |          3           | Werner Lang  |  Done  |
|            |                                                 | T111 | Implementar endpoint POST /services                              | Crear endpoint con autenticación                                                                     |          2           | Werner Lang  |  Done  |
|            |                                                 | T112 | Pruebas de creación de servicio                                  | Verificar creación exitosa                                                                           |          2           | Werner Lang  |  Done  |
|  **TS05**  |     Obtener servicios por cliente o técnico     | T113 | Crear queries para servicios                                     | Definir GetServicesByClientIdQuery y GetServicesByTechnicianIdQuery                                  |          2           | Werner Lang  |  Done  |
|            |                                                 | T114 | Implementar métodos de repositorio                               | Crear FindByClientIdAsync y FindByTechnicianIdAsync                                                  |          3           | Werner Lang  |  Done  |
|            |                                                 | T115 | Implementar IServiceQueryService                                 | Crear interfaz con métodos Handle                                                                    |          2           | Werner Lang  |  Done  |
|            |                                                 | T116 | Implementar ServiceQueryService                                  | Crear implementación de queries                                                                      |          3           | Werner Lang  |  Done  |
|            |                                                 | T117 | Implementar endpoints GET /services                              | Crear endpoints con filtros por cliente y técnico                                                    |          3           | Werner Lang  |  Done  |
|            |                                                 | T118 | Pruebas de consulta de servicios                                 | Verificar obtención correcta por filtros                                                             |          2           | Werner Lang  |  Done  |
|  **TS07**  |          Actualizar estado de servicio          | T119 | Crear commands de estado                                         | Definir CompleteServiceCommand, ConfirmServiceCommand, CancelServiceCommand                          |          2           | Werner Lang  |  Done  |
|            |                                                 | T120 | Implementar métodos en Services                                  | Crear Complete(), Confirm(), Cancel() con validaciones de estado                                     |          4           | Werner Lang  |  Done  |
|            |                                                 | T121 | Implementar handlers en ServiceCommandService                    | Implementar Handle para cada command de estado                                                       |          4           | Werner Lang  |  Done  |
|            |                                                 | T122 | Implementar endpoints PATCH                                      | Crear /services/{id}/complete, /confirm, /cancel                                                     |          3           | Werner Lang  |  Done  |
|            |                                                 | T123 | Pruebas de transiciones                                          | Verificar transiciones válidas e inválidas de estado                                                 |          3           | Werner Lang  |  Done  |
|  **TS09**  |               Crear nueva reseña                | T124 | Crear SubmitReviewCommand                                        | Definir command con TechnicianId, ClientId, Rating, Comment                                          |          1           |              | To do  |
|            |                                                 | T125 | Crear entidad Reviews                                            | Implementar agregado Reviews con validaciones (rating 1-5)                                           |          3           |              | To do  |
|            |                                                 | T126 | Implementar IReviewRepository                                    | Crear interfaz de repositorio                                                                        |          2           |              | To do  |
|            |                                                 | T127 | Implementar ReviewRepository                                     | Crear implementación con Entity Framework                                                            |          3           |              | To do  |
|            |                                                 | T128 | Implementar IReviewCommandService                                | Crear interfaz con método Handle                                                                     |          1           |              | To do  |
|            |                                                 | T129 | Implementar ReviewCommandService.Handle(SubmitReviewCommand)     | Crear lógica de creación con validaciones                                                            |          3           |              | To do  |
|            |                                                 | T130 | Implementar endpoint POST /review                                | Crear endpoint con autenticación                                                                     |          2           |              | To do  |
|            |                                                 | T131 | Pruebas de creación de reseña                                    | Verificar creación y validaciones de rating                                                          |          2           |              | To do  |
|  **TS08**  |          Obtener reseñas de un técnico          | T132 | Crear GetReviewsByTechnicianIdQuery                              | Definir query con TechnicianId                                                                       |          1           |              | To do  |
|            |                                                 | T133 | Implementar FindByTechnicianIdAsync                              | Crear método en repositorio                                                                          |          2           |              | To do  |
|            |                                                 | T134 | Implementar IReviewQueryService                                  | Crear interfaz con método Handle                                                                     |          1           |              | To do  |
|            |                                                 | T135 | Implementar ReviewQueryService                                   | Crear implementación de query                                                                        |          2           |              | To do  |
|            |                                                 | T136 | Implementar endpoint GET /review/technician/{technicianId}       | Crear endpoint público o protegido                                                                   |          2           |              | To do  |
|            |                                                 | T137 | Pruebas de consulta de reseñas                                   | Verificar obtención correcta de reseñas por técnico                                                  |          2           |              | To do  |
